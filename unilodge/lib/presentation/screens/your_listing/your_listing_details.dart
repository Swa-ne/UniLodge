...
class _YourListingDetailsState extends State<YourListingDetails> {
  ...
  void initState() {
    ...
    bookingsData = [
      {
        'propertyType': widget.listing.selectedPropertyType ?? 'N/A',
        'userName': 'User 1',
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => BookingBloc(
        RepositoryProvider.of(context), // Make sure BookingBloc is provided here
      ),
      child: BlocListener<ListingBloc, ListingState>(
          ...
          body: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                BookingManagementWidget(bookingsData: bookingsData),
