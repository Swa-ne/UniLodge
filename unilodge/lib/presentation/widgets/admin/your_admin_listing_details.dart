...
class YourAdminListingDetails extends StatefulWidget {
  const YourAdminListingDetails({super.key, required this.listing});

  final Listing listing;

  @override
  State<YourAdminListingDetails> createState() =>
      _YourAdminListingDetailsState();
}

class _YourAdminListingDetailsState extends State<YourAdminListingDetails> {
