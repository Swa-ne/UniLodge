...
class PaymentDetails extends StatefulWidget {
  const PaymentDetails({super.key, required this.listing});
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: TextRow(
                text1: "Owner:", text2: widget.listing.owner_id?.full_name ?? ''),
          ),
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 16.0),
            child: TextRow(
                text1: "Type:", text2: widget.listing.selectedPropertyType ?? ''),
          ),
          Theme(
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Expanded(
                        child: Text(
                          widget.listing.leastTerms ?? "No lease terms available",
                          style: const TextStyle(
                            color: AppColors.formTextColor,
                            fontSize: 15,
                          ),
